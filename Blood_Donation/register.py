...
def is_valid_email(email):
    ...
    if re.match(pattern, email):
        ...
        messagebox.showinfo("Enter valid email")




def create_user(en1,en2,en3,en5,en6,en7,en8,en10):
    user = en5.get()
    name=en1.get()
    age=en2.get()
    phone_no=en3.get()
    ...
    params = (name,age,phone_no,user, pwd,weight,disease,gender,bloodgroup)
    query = "Insert into blood_info(FULLNAME,AGE,PHONE,USERNAME,PWD,WEIGHT,DISEASE,GENDER,BLOODGROUP) Values(%s,%s,%s,%s,SHA(%s),%s,%s,%s,%s)"
...
b1 = Button(f, text="Sign up", font=("Times New Roman", 16), height=1, width=8,command=lambda: create_user(en1,en2,en3,en5,en6,en7,en8,en10))
