...
class HomePage:
    ...
    def setup_homepage(self):
        ...
        self.admin_login_b = Button(self.lbFrame, text="view table page", command=lambda: self.login("admin"), font=('Times New Roman', 25))
        ...
        self.lbl = Label(self.root,image=self.imagee_tk)
